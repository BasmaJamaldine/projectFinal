<x-app-layout>
    <div class="min-h-screen  ">
        <div class="w-[70vw] mx-auto px-4 sm:px-6 lg:px-8">
            <div class="bg-white rounded-3xl shadow-xl overflow-hidden">
                <div class="p-8">
                    <div class="mb-8">
                        <h1 class="text-4xl font-clash font-semibold mb-4">
                            <span class="bg-[#f9c365] px-4 py-2 rounded-full">{{ $finalProject->title }}</span>
                        </h1>
                    </div>
                    <form action="{{ route('projetfinal.submit', ['finalProject' => $finalProject->id]) }}" method="POST" class="space-y-8">
                        @csrf
