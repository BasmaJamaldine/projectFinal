                ...
                <div class="  flex flex-col justify-center items-center">
                    ...
                    <nav
                        ...
                        <div class="flex flex-row gap-3 mt-4">
                            ...
                            <x-nav-link :href="route('calendriershow')" :active="request()->routeIs('Courses')" class="text-lg  hover:text-[#fac365] hover:bg-[#1d1d1d] hover:font-bold hover:px-3 hover:rounded-e-full">
                                {{ __('Courses') }}
                            </x-nav-link>
                        </div>
