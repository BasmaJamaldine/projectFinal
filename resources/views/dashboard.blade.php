            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div class="p-4">
                        <div class="flex items-center justify-between mb-3">
                            <div class="bg-[#fef7e4] p-2 rounded-xl">
                                <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 text-[#fac365]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <div class="text-center">
                            <h3 class="text-3xl font-clash font-bold text-gray-900 mb-1">{{ $totalcourses }}</h3>
                ...
                <div class="bg-white rounded-2xl shadow-lg overflow-hidden transform hover:scale-102 transition-all duration-300">
                    <div class="p-4">
                        ...
                        <div class="text-center">
                            <h3 class="text-3xl font-clash font-bold text-gray-900 mb-1">{{ $totaluser }}</h3>
                ...
                <div class="bg-white rounded-2xl shadow-lg overflow-hidden transform hover:scale-102 transition-all duration-300">
                    <div class="p-4">
                        ...
                        <div class="text-center">
                            <h3 class="text-3xl font-clash font-bold text-gray-900 mb-1">{{ $totalcoach }}</h3>
    ...
    <div class="modal-dialog">
        <div class="modal-content bg-white rounded-3xl shadow-2xl">
            <div class="modal-header border-b border-[#fac365] p-6">
                <h5 class="modal-title text-2xl font-clash font-semibold text-gray-900" id="exampleModalLabel">
                    Add New Course
                </h5>
                <button type="button" class="text-gray-400 hover:text-[#fac365] transition-colors duration-200" data-bs-dismiss="modal" aria-label="Close">
            ...
            <div class="modal-body p-6">
                <form action="{{ route('courses.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                    @csrf
                    <div>
                        <label for="name" class="block text-lg font-semibold text-[#4a654f]">Course Name</label>
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            <label for="start" class="block text-lg font-semibold text-[#4a654f]">Start Date</label>
                        ...
                        <div>
                            <label for="end" class="block text-lg font-semibold text-[#4a654f]">End Date</label>
                    ...
                    <div>
                        <label for="max_students" class="block text-lg font-semibold text-[#4a654f]">Maximum Students</label>
                    ...
                    <div>
                        <label for="type" class="block text-lg font-semibold text-[#4a654f]">Course Type</label>
                        <select name="type" 
                            class="mt-1 block w-full rounded-2xl border-2 border-[#F4DFC8] shadow-sm focus:border-[#183D3D] focus:ring focus:ring-[#fac365] focus:ring-opacity-50 py-2 px-3"
                            required>
                    ...
                    <div>
                        <label for="image" class="block text-lg font-semibold text-[#4a654f]">Course Image</label>
                        <div class="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-[#F4DFC8] border-dashed rounded-2xl">
                            <div class="space-y-1 text-center">
                                ...
                                <div class="flex text-sm text-gray-600">
                                    <label for="image" class="relative cursor-pointer rounded-md font-medium text-[#fac365] hover:text-[#e9b74b] focus-within:outline-none">
